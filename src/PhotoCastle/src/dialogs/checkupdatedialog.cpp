    ...
    ui(new Ui::checkupdateDialog)
{
    ...
    manager->get(QNetworkRequest(QUrl("https://raw.githubusercontent.com/PhotoCastle/PhotoCastle/master/versions/stable.json")));
}
...
{
    QString link = "https://PhotoCastle.io/downloads/";
