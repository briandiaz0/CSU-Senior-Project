/********************************************************************************
** Form generated from reading UI file 'photocastlewindow.ui'
**
...
#ifndef UI_PHOTOCASTLEWINDOW_H
#define UI_PHOTOCASTLEWINDOW_H
...
""));
        ...
        menuFile->addSeparator();
        menuFile->addAction(actionImage_properties);
        menuFile->addSeparator();
        menuFile->addAction(actionQuit);
        menuEdit->addAction(actionUndo);
        menuEdit->addAction(actionRedo);
        menuEdit->addAction(actionFade);
        ...
        menuEdit->addSeparator();
        menuEdit->addAction(actionPaste_as_new_image);
        menuEdit->addAction(actionPaste_special);
        menuEdit->addSeparator();
        menuEdit->addAction(actionStroke_and_fill);
        menuEdit->addAction(actionOptimized_Clipping);
        menuEdit->addSeparator();
        ...
        menuEdit->addSeparator();
        menuEdit->addAction(menuPurge->menuAction());
        menuPurge->addAction(actionClearHistory);
        menuPurge->addAction(actionClearClipboard);
        ...
        menuImage->addAction(actionOutside_frame);
        menuImage->addAction(actionOutside_drop_shadow);
        menuImage->addSeparator();
        menuImage->addAction(actionTransparent_colour);
        menuImage->addAction(actionAutomatic_transparency);
        menuImage->addAction(actionTransparency_mask);
        menuImage->addSeparator();
        menuImage->addAction(actionText);
        menuImage->addAction(actionCopyright);
        ...
        menuSelection->addAction(actionShow_selection);
        menuSelection->addAction(actionSelect_all);
        menuSelection->addSeparator();
        menuSelection->addAction(actionSet_shape);
        menuSelection->addAction(actionInvert);
        menuSelection->addAction(actionManual_settings);
        menuSelection->addSeparator();
        menuSelection->addAction(actionCenter);
        menuSelection->addAction(actionFit_ratio);
        menuSelection->addAction(actionContract);
        menuSelection->addAction(actionExpand);
        menuSelection->addAction(actionTransform_2);
        menuSelection->addSeparator();
        menuSelection->addAction(actionAntialiasing);
        menuSelection->addAction(actionBounding_box);
        menuSelection->addAction(actionPaste_and_text_bounding_box);
        menuSelection->addSeparator();
        menuSelection->addAction(actionCopy_shape);
        menuSelection->addAction(actionPaste_shape);
        menuSelection->addSeparator();
        menuSelection->addAction(actionLoad_shape);
        menuSelection->addAction(actionSave_shape);
        menuAdjust->addAction(actionBright_Contrast);
        menuAdjust->addAction(actionHue_variation);
        menuAdjust->addAction(actionColour_balance);
        menuAdjust->addAction(actionGamma_correct);
        menuAdjust->addSeparator();
        menuAdjust->addAction(actionAuto_levels);
        menuAdjust->addAction(actionAuto_contrast);
        menuAdjust->addSeparator();
        menuAdjust->addAction(actionMore_shadows);
        menuAdjust->addAction(actionMore_highlights);
        menuAdjust->addAction(actionLevels);
        menuAdjust->addSeparator();
        menuAdjust->addAction(actionSwap_RGB_channel);
        menuAdjust->addAction(actionReplace_colour);
        menuAdjust->addAction(actionReplace_colour_range);
        menuAdjust->addSeparator();
        menuAdjust->addAction(actionDuotone);
        menuAdjust->addAction(actionDithering);
        menuAdjust->addAction(actionNegative);
        menuAdjust->addAction(actionPosterize);
        menuAdjust->addSeparator();
        menuAdjust->addAction(actionOpacity);
        menuFilter->addAction(menuSoften->menuAction());
        menuFilter->addAction(menuSharpen->menuAction());
        menuFilter->addAction(menuNoise->menuAction());
        menuFilter->addAction(actionRelief);
        menuFilter->addAction(menuColour->menuAction());
        menuFilter->addSeparator();
        menuFilter->addAction(menuArtistic->menuAction());
        menuFilter->addAction(menuVisual_Effect->menuAction());
        menuFilter->addAction(menuDeform->menuAction());
        menuFilter->addAction(actionStylize);
        menuFilter->addAction(actionAged_effect);
        menuFilter->addSeparator();
        menuFilter->addAction(menuFrame->menuAction());
        menuFilter->addAction(menuFlatten->menuAction());
        menuFilter->addAction(menuEdges->menuAction());
        menuFilter->addAction(actionTexture);
        menuFilter->addAction(actionOther);
        ...
        menuTools->addAction(actionSet_wallpaper);
        menuTools->addAction(actionExport_as_icon);
        menuTools->addSeparator();
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Photoflare", nullptr));
