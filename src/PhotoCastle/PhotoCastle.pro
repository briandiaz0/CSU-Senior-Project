...
SOURCES += src/main.cpp \
    ...
    src/photocastlesettings.cpp \
    src/photocastlewindow.cpp \
...
HEADERS += \
    ...
    src/photocastlesettings.h \
    src/photocastlewindow.h \
...
unix:!macx {
    ...
    pixmaps.files = installers/deb/DEBIAN/usr/share/icons/hicolor/48x48/apps/PhotoCastle.png
    ...
    manpage.files = PhotoCastle.1
    appstream.path = $${PREFIX}/share/metainfo/
    appstream.files = io.PhotoCastle.PhotoCastle.appdata.xml
